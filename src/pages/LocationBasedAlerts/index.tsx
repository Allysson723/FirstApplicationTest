...
const LocationBasedAlertsPage: React.FC = () => {
  return (
    <>
      <div
        className="bg-cover bg-no-repeat bg-white-A700 flex flex-col font-gilroy h-[1024px] items-center justify-end mx-auto pt-[826px] w-full"
        style={{ backgroundImage: "url('images/img_automatedemail.png')" }}
      >
        <div className="flex flex-col gap-5 justify-start w-full">
          <div className="bg-white-A700 flex flex-col items-center justify-end md:ml-[0] ml-[1014px] mr-6 p-3.5 md:px-5 rounded-[13px] w-[28%] md:w-full">
