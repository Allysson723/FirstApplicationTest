...
const EnableLinkedAccountsPage: React.FC = () => {
              ...
              <div className="flex flex-col items-center justify-start w-full">
                <div className="flex flex-col gap-3.5 justify-start w-full">
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start ml-10 md:ml-[0] w-[73%] md:w-full">
                    ...
                    <Text
                      className="md:ml-[0] ml-[34px] text-base text-blue-A700"
                  ...
                  <div className="flex flex-col relative w-full">
                    ...
                    <Line className="bg-blue-A700 h-0.5 mb-auto ml-[173px] mt-[-1px] w-[11%] z-[1]" />
                  </div>
                </div>
              </div>
            </div>
